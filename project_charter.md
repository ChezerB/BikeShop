...
![Stakeholders Analysis Matrix](SAM.png) 
### 6.2 Communications Plan

## Communications Plan

| Stakeholder Group                        | Channel        | Schedule           | Purpose / Content                                  | Owner               |
|-----------------------------------------|----------------------------|-------------------|--------------------------------------------------|-------------------|
...
| Department Head  |     Email / Zoom Meetings    | Bi-weekly |  Summary of progress, high-level issues    |       Project Manager    |     |
